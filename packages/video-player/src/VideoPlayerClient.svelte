...
<script>
  ...
  import { uid, preloadImage, prepareVideoSources } from './helpers/utils';

  import Poster from './core/Poster.svelte';
  import Controls from './core/Controls.svelte';
  import CenterIcons from './icons/CenterIcons.svelte';
  import BottomControls from './core/BottonControls.svelte';
  import Playbar from './Playbar.svelte';
  import PlayPauseButton from './button/PlayPauseButton.svelte';
  import VolumeButton from './button/VolumeButton.svelte';
  import VolumeControl from './VolumeControl.svelte';
  import FullscreenButton from './button/FullscreenButton.svelte';
